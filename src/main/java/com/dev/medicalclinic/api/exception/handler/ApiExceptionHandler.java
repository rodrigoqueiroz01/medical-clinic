...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleNotFound(HttpClientErrorException.NotFound ex, WebRequest request) {
        var status = HttpStatus.NOT_FOUND;
    ...
    protected ResponseEntity<Object> handleNotFound(HttpClientErrorException.BadRequest ex, WebRequest request) {
        var status = HttpStatus.BAD_REQUEST;
